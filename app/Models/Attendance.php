...
class Attendance extends Model
{
    ...
    protected $fillable = array('adjustment_staff_id','branch_id', 'attendance_date', 'in_time', 'in_time_reason', 'lunch_start', 'lunch_end', 'out_time', 'out_time_reason', 'in_location', 'out_location', 'lunch_start_location', 'lunch_end_location','np_year', 'np_month', 'np_date','approve', 'manual');
    
    public function adjustment_staff()
    {
        return $this->belongsTo('App\Models\Adjustment_staff','adjustment_staff_id');
    }
    ...
    {
    	$data = Attendance::select('in_time')->where('adjustment_staff_id', $id)->where('attendance_date', date('Y-m-d'))->first();
    ...
    {
    	$data = Attendance::select('lunch_start')->where('adjustment_staff_id', $id)->where('attendance_date', date('Y-m-d'))->first();
    ...
    {
    	$data = Attendance::select('lunch_end')->where('adjustment_staff_id', $id)->where('attendance_date', date('Y-m-d'))->first();
    ...
    {
    	$data = Attendance::select('out_time')->where('adjustment_staff_id', $id)->where('attendance_date', date('Y-m-d'))->first();
    ...
    {
    	$data = Attendance::select('in_location')->where('adjustment_staff_id', $id)->where('attendance_date', date('Y-m-d'))->first();
    ...
    {
    	$data = Attendance::select('lunch_start_location')->where('adjustment_staff_id', $id)->where('attendance_date', date('Y-m-d'))->first();
    ...
    {
    	$data = Attendance::select('lunch_end_location')->where('adjustment_staff_id', $id)->where('attendance_date', date('Y-m-d'))->first();
    ...
    {
    	$data = Attendance::select('out_location')->where('adjustment_staff_id', $id)->where('attendance_date', date('Y-m-d'))->first();
